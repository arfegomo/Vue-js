...
methods:{  
        btnAlta: async function(){
            ...
            html:
                ...
                '</div>'+
                '<div class="row">'+
                '<label class="col-sm-3 col-form-laber">Modelo</label>'+
                '<div class="col-sm-7">'+
        ...
        btnEditar:async function(id, marca, modelo, stock){                            
            ...
            '<div class="row">'+
                '<label class="col-sm-3 col-form-label">Marca</label>'+
                '<div class="col-sm-7">'+
                '<input id="marca" type="text" value="'+marca+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="row">'+
                '<label class="col-sm-3 col-form-laber">Modelo</label>'+
                '<div class="col-sm-7">'+
                '<input id="modelo" type="text" value="'+modelo+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="row">'+
                '<label class="col-sm-3 col-form-label">Stock</label>'+
    ...
    altaMovil:function(){
            ...
            //console.log(axios.post(url, {opcion:1, marca:this.marca, modelo:this.modelo,stock:this.stock }));
            this.listarMoviles();
        });        
             this.marca = "",
             this.modelo = "",
